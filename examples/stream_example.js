console.log( "Make sure you run : npm install onvif socket.io rtsp-ffmpeg and sudo apt install ffmpeg")
...
const { Cam } = require('../promises'), io = require('socket.io')(server), rtsp = require('rtsp-ffmpeg');
server.listen(6147);
